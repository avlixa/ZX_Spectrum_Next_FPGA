# Clock Signal
create_clock -period 7.407 -name dp_refclk_p_i -waveform {0.000 3.704} -add [get_ports dp_refclk_p_i]
create_clock -period 7.407 -name dp_refclk_n_i -waveform {0.000 3.704} -add [get_ports dp_refclk_n_i]
