...
#
# Generated by export_simulation on Thu Apr 21 14:46:59 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './sdpram_64_9.sh' script.

./sdpram_64_9.sh -reset_run
...
./sdpram_64_9.sh -noclean_files

For more information on the script, please type './sdpram_64_9.sh -help'.
