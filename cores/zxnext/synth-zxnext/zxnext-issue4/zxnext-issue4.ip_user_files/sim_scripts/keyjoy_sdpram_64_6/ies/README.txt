...
#
# Generated by export_simulation on Thu Apr 21 14:40:29 -0600 2022
#
################################################################################
...
'-reset_run' switch to the './keyjoy_sdpram_64_6.sh' script.

./keyjoy_sdpram_64_6.sh -reset_run
...
./keyjoy_sdpram_64_6.sh -noclean_files

For more information on the script, please type './keyjoy_sdpram_64_6.sh -help'.
